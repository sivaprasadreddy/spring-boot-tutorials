...
public class TweetRecordProcessor implements IRecordProcessor {

    private static final Log LOG = LogFactory.getLog(TweetRecordProcessor.class);
    ...
    private void processSingleRecord(Record record) {
        ...
        try {
            ...
            LOG.info("Tweet Received. data="+data+","+record.getSequenceNumber() + ", " + record.getPartitionKey());
